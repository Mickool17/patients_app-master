...
class Payments extends StatefulWidget {
  ...
  @override
  State<Payments > createState() => _PurchasesState();
}

class _PurchasesState extends State<Payments > {
  ...
  Widget buildAppointmentDetails(TextStyle appointmentDetailsTextStyle) {
    return Column(
      ...
      children: [
        Text("Purchase reminder", style: appointmentDetailsTextStyle),
