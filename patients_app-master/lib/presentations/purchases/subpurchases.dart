...
class SubPurchases extends StatefulWidget {
  const SubPurchases({super.key});

  @override
  State<SubPurchases> createState() => _SubPurchasesState();
}

class _SubPurchasesState extends State<SubPurchases> {
